...
(async () => {
  try {
    ...
    const urlPatterns = new Map([
      ...
      ["notLivingInfo", /https?:\/\/(?:social|argo)\.blued\.cn\/users\/\d+/], // 修改了正则表达式
    ...
    for (const [key, pattern] of urlPatterns) {
      if (pattern.test(currentUrl) && currentUrl !== "https://argo.blued.cn/users/75671136?is_living=false&from=online&is_call=1&is_live_flow=1&is_shadow=0&is_vip_page=0") {
